        ...
        <table class="table table-bordered bs-table">
            ...
            <tbody>
                @foreach ($products as $p)
                    <!--ตัวแปร products ที่ถูกส่งมาจาก controller ไงครับ  // ผมแนะนําให้เวลาเขียนโปรแกรม
                                    ทดลองซักฟิลด์เดียวก่อน
                                    // ถ้าโปรแกรมแสดงผลออกมาได้ จึงค่อยทําฟิลด์ต่อๆไป-->
                    <tr>
...
<script>
    $('.btn-delete').on('click', function() { if(confirm("คูณต้องการลบข้อมูลสินค้าหรือไม่?")) {
